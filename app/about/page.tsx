...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_74%_18%,rgba(201,214,223,0.13),transparent_32%)]" />
      ...
      <section className="px-6 py-20 sm:py-28">
        <div className="mx-auto max-w-4xl">
          ...
          <section
            id="how-it-works"
            className="overflow-hidden rounded-[2rem] border border-[rgba(248,250,252,0.12)] bg-[rgba(11,31,53,0.74)] p-8 shadow-2xl backdrop-blur-xl sm:p-10"
          >
            ...
            <p className="leading-8 text-[rgba(248,250,252,0.82)]">
            ...
            <p className="mt-5 leading-8 text-[rgba(248,250,252,0.82)]">
