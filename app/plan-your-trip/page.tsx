...
export default function PlanYourTripPage() {
  return (
    <>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_74%_18%,rgba(84,224,166,0.15),transparent_32%)]" />
      ...
      <section className="px-6 py-20 sm:py-28">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1fr)_420px]">
          <div className="rounded-[2rem] border border-[rgba(248,250,252,0.12)] bg-[rgba(11,31,53,0.76)] p-6 shadow-2xl backdrop-blur-xl sm:p-8">
            <PlanForm />
          </div>

          <aside className="self-start overflow-hidden rounded-[2rem] border border-[rgba(248,250,252,0.12)] bg-[rgba(11,31,53,0.72)] shadow-2xl backdrop-blur-xl">
            <div className="h-52 bg-[linear-gradient(145deg,rgba(7,24,39,0.52),rgba(84,224,166,0.12)),url('https://images.unsplash.com/photo-1517299321609-52687d1bc55a?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center" />
            <div className="p-8">
              ...
              <div className="mt-7 border-t border-[rgba(201,214,223,0.08)] pt-6 text-xs leading-6 text-[rgba(248,250,252,0.46)]">
